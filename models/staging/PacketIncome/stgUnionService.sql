...
WHERE       dbo.Packet.Opened >= '01-01-2015 00:00:00' AND dbo.Packet.Opened IS NOT NULL AND ServiceType Like 'AddService'
UNION 
...
WHERE       dbo.Packet.Opened >= '01-01-2015 00:00:00' AND dbo.Packet.Opened IS NOT NULL AND ServiceType Like 'Item'
UNION
...
WHERE       dbo.ArchivePacket.Opened >= '01-01-2015 00:00:00' AND dbo.ArchivePacket.Opened IS NOT NULL AND ServiceType Like 'AddService'
UNION
...
WHERE       dbo.ArchivePacket.Opened >= '01-01-2015 00:00:00' AND dbo.ArchivePacket.Opened IS NOT NULL AND ServiceType Like 'Item'
